...
<div class="category-tabs">
  <button class="cat-tab active" data-category="Todos">Todos</button>
  <button class="cat-tab" data-category="Libros">📚 Libros</button>
  <button class="cat-tab" data-category="Herramientas">🛠️ Herramientas</button>
  <button class="cat-tab" data-category="Tutorías">📄 Tutorías</button>
  <button class="cat-tab" data-category="Trueque">🔁 Trueque</button>
  <button class="cat-tab" data-category="Donaciones">🎁 Donaciones</button>
  <button class="cat-tab" data-category="Ropa y Moda">👕 Ropa</button>
  <button class="cat-tab" data-category="Se Busca">🔍 Se Busca</button>
</div>
  ...
  <div class="modal-card modal-wide">
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        ...
        <input type="file" id="prodImageFile" accept="image/*" capture="environment">
      </div>
...
<div class="layout">
  ...
  <main class="main-content">
    ...
    <section class="section hidden" id="section-comprar">
      ...
      <div class="loading-skeleton" id="buyLoadingSkeleton"></div>
